...
namespace ALedgerApi.Repository
{
    public class PersonRepository : BaseRepository<
            Model.Person.Comm.Person,
            DBBase<Model.Person.Comm.Person>,
            DBListBase<Model.Person.Comm.Person, Model.DB.DBBase<Model.Person.Comm.Person>>,
            DBBaseLog<Model.Person.Comm.Person>
        >
    {
        public PersonRepository(IElasticClient elasticClient) : base(elasticClient)
        {
        }
    }
}
