...
namespace ALedgerBFFApi.Controllers
{
    ...
    [Route("v1")]
    [ApiController]
    public class User2PersonController : Controller
    {
        private readonly OpenApiClient.Client client;
        private readonly HttpClient httpClient = new HttpClient();
        private readonly IOptionsMonitor<ObjectStorage> objectStorageConfig;
        private readonly ILogger<User2PersonController> logger;
        public User2PersonController(ILogger<User2PersonController> logger, IOptionsMonitor<ObjectStorage> objectStorageConfig, IOptionsMonitor<BFF> bffConfig) : base()
        {
            this.logger = logger;
